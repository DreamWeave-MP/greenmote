...
const fn settings_text(key: UiText) -> &'static str {
    match key {
        ...
        UiText::RoadTexturePaths => "Road texture paths",
        UiText::NoRoadTexturePaths => "No road texture path filters configured.",
        ...
        UiText::AddRoadTexturePathRegexTitle => "Add road texture path regex",
        ...
        UiText::RoadTexturePathRegexPrompt => "Road texture path regex",
        _ => unreachable!(),
    }
}
